...
public class PoliceFile implements Serializable {
	...
	public void  setIndexDatesOfConvictions(int index) {this.IndexDatesOfConvictions=index;}
	/////////////////////////////////////////////////////
...
/////////////////////////
         ...
         j++;
		     ...
		     if (Regex.Name(value1)==false) {System.out.println("Помилка вводу\n " ); ;}
		     else{ add.setName(value1);}
...
/////////////////////////////
		  ...
		  int i=0;
             n=2;
             if (Regex.Data(value1)==false) {System.out.println("Помилка вводу\n " ); ;}
              else{			 
			for(;i<n;i++)
...
//////!//////////////////////////
            ...
            while (openf.length()>=j+1&&openf.charAt(j)!=59) 
	     {
                   ...
                   if (Regex.Data(value1)==false) {System.out.println("Помилка вводу\n " ); ;}
				    ...
				    add.setIndexDatesOfConvictions(index);
				    index++;size++;
         		     j++;
				    value1=new String();
